...
*/ var _Scheduler_working = false;
    ...
    var $author$project$Main$AddCategoryInput = {
        $: 'AddCategoryInput'
    };
    ...
    var $author$project$Data$Id$encode = function(_v0) {
        var string = _v0.a;
        return $elm$json$Json$Encode$string(string);
    };
    var $elm$json$Json$Encode$int = _Json_wrap;
    var $author$project$Data$Money$encode = function(_v0) {
        var _int = _v0.a;
    ...
    var $author$project$Data$Bucket$encode = function(bucket) {
    ...
    var $author$project$Data$Category$encode = function(category) {
        return $elm$json$Json$Encode$object(_List_fromArray([
            _Utils_Tuple2('id', $author$project$Data$Id$encode(category.id)),
            _Utils_Tuple2('name', $elm$json$Json$Encode$string(category.name))
        ]));
    };
    ...
    var $turboMaCk$any_dict$Dict$Any$encode = F2(function(keyE, valueE) {
        return A2($elm$core$Basics$composeL, A2($elm$core$Basics$composeL, $elm$json$Json$Encode$object, $elm$core$List$map(A2($elm$core$Tuple$mapBoth, keyE, valueE))), $turboMaCk$any_dict$Dict$Any$toList);
    });
    var $author$project$Data$Id$unwrap = function(_v0) {
        var string = _v0.a;
        return string;
    };
    var $author$project$Data$IdDict$encode = F2(function(encodeValue, _v0) {
        var dict = _v0.a;
        return A3($turboMaCk$any_dict$Dict$Any$encode, $author$project$Data$Id$unwrap, encodeValue, dict);
    });
    ...
    var $author$project$Main$encodeSavedModel = function(model) {
        return A2($elm$json$Json$Encode$encode, 0, $elm$json$Json$Encode$object(_List_fromArray([
            _Utils_Tuple2('categories', A2($author$project$Data$IdDict$encode, $author$project$Data$Category$encode, model.categories)),
            _Utils_Tuple2('buckets', A2($author$project$Data$IdDict$encode, $author$project$Data$Bucket$encode, model.buckets)),
            _Utils_Tuple2('categoriesOrder', A2($elm$json$Json$Encode$list, $author$project$Data$Id$encode, model.categoriesOrder)),
            _Utils_Tuple2('bucketsOrder', A2($author$project$Data$IdDict$encode, $elm$json$Json$Encode$list($author$project$Data$Id$encode), model.bucketsOrder))
        ])));
    };
    var $author$project$Main$FocusAttempted = {
        $: 'FocusAttempted'
    };
    ...
    var $author$project$Main$domIdToString = function(domId_) {
        switch(domId_.$){
            case 'AddCategoryInput':
                return 'add-category';
            case 'AddBucketInput':
                var categoryId = domId_.a;
                return 'add-bucket-' + $author$project$Data$Id$unwrap(categoryId);
            default:
                var bucketId = domId_.a;
                return 'money-op-' + $author$project$Data$Id$unwrap(bucketId);
        }
    };
    var $elm$browser$Browser$Dom$focus = _Browser_call('focus');
    var $author$project$Main$focus = function(id) {
        return A2($elm$core$Task$attempt, function(_v0) {
            return $author$project$Main$FocusAttempted;
        }, $elm$browser$Browser$Dom$focus($author$project$Main$domIdToString(id)));
    };
    var $author$project$Data$IdDict$IdDict = function(a) {
        return {
            $: 'IdDict',
            a: a
        };
    ...
    var $author$project$Main$initSavedModel = {
        buckets: $author$project$Data$IdDict$empty,
        bucketsOrder: $author$project$Data$IdDict$empty,
        categories: $author$project$Data$IdDict$empty,
        categoriesOrder: _List_Nil
    };
    ...
    var $author$project$Main$SavedModel = F4(function(categories, buckets, categoriesOrder, bucketsOrder) {
        return {
            buckets: buckets,
    ...
    var $author$project$Data$Id$Id = function(a) {
        return {
            $: 'Id',
            a: a
        };
    ...
    var $author$project$Data$Money$Money = function(a) {
        return {
            $: 'Money',
            a: a
        };
    ...
    var $author$project$Data$Category$decoder = A3($elm$json$Json$Decode$map2, $author$project$Data$Category$Category, A2($elm$json$Json$Decode$field, 'id', $author$project$Data$Id$decoder), A2($elm$json$Json$Decode$field, 'name', $elm$json$Json$Decode$string));
    ...
    var $turboMaCk$any_dict$Dict$Any$insert = F3(function(k, v, _v0) {
        var inner = _v0.a;
        return $turboMaCk$any_dict$Dict$Any$AnyDict(_Utils_update(inner, {
            dict: A3($elm$core$Dict$insert, inner.toKey(k), _Utils_Tuple2(k, v), inner.dict)
        }));
    });
    var $turboMaCk$any_dict$Dict$Any$decode = F3(function(fromStr, toComparable, valueD) {
        var construct = F3(function(strK, v, acc) {
            return A3($turboMaCk$any_dict$Dict$Any$insert, A2(fromStr, strK, v), v, acc);
        });
        return A2($elm$json$Json$Decode$map, A2($elm$core$Dict$foldr, construct, $turboMaCk$any_dict$Dict$Any$empty(toComparable)), $elm$json$Json$Decode$dict(valueD));
    });
    var $author$project$Data$Id$fromString = function(string) {
        return $author$project$Data$Id$Id(string);
    };
    var $author$project$Data$IdDict$decoder = function(valueDecoder) {
        return A2($elm$json$Json$Decode$map, $author$project$Data$IdDict$IdDict, A3($turboMaCk$any_dict$Dict$Any$decode, F2(function(idString, _v0) {
            return $author$project$Data$Id$fromString(idString);
        }), $author$project$Data$Id$unwrap, valueDecoder));
    };
    var $elm$json$Json$Decode$list = _Json_decodeList;
    var $author$project$Main$savedModelDecoder = A5($elm$json$Json$Decode$map4, $author$project$Main$SavedModel, A2($elm$json$Json$Decode$field, 'categories', $author$project$Data$IdDict$decoder($author$project$Data$Category$decoder)), A2($elm$json$Json$Decode$field, 'buckets', $author$project$Data$IdDict$decoder($author$project$Data$Bucket$decoder)), A2($elm$json$Json$Decode$field, 'categoriesOrder', $elm$json$Json$Decode$list($author$project$Data$Id$decoder)), A2($elm$json$Json$Decode$field, 'bucketsOrder', $author$project$Data$IdDict$decoder($elm$json$Json$Decode$list($author$project$Data$Id$decoder))));
    ...
    var $author$project$Main$init = function(flags) {
        ...
        return _Utils_Tuple2(A2($author$project$Main$initModel, $elm$random$Random$initialSeed(flags.idSeed), savedModel), $elm$core$Platform$Cmd$batch(_List_fromArray([
            $author$project$Main$focus($author$project$Main$AddCategoryInput),
    ...
    var $author$project$Main$AddM = function(a) {
        return {
            $: 'AddM',
            a: a
        };
    ...
    var $author$project$Main$MoveToM = F2(function(a, b) {
        return {
            $: 'MoveToM',
            a: a,
            b: b
    ...
    var $author$project$Main$SetM = function(a) {
        return {
            $: 'SetM',
            a: a
        };
    };
    var $author$project$Main$SubtractM = function(a) {
        return {
            $: 'SubtractM',
            a: a
        };
    ...
    var $author$project$Data$Money$add = F2(function(_v0, _v1) {
        var int1 = _v0.a;
        var int2 = _v1.a;
        return $author$project$Data$Money$Money(int1 + int2);
    });
    ...
    var $turboMaCk$any_dict$Dict$Any$filter = F2(function(f, _v0) {
        var inner = _v0.a;
        return $turboMaCk$any_dict$Dict$Any$AnyDict(_Utils_update(inner, {
            dict: A2($elm$core$Dict$filter, F2(function(_v1, _v2) {
                var k = _v2.a;
                var v = _v2.b;
                return A2(f, k, v);
            }), inner.dict)
    ...
    var $author$project$Data$IdDict$filter = F2(function(pred, _v0) {
        var dict = _v0.a;
        return $author$project$Data$IdDict$IdDict(A2($turboMaCk$any_dict$Dict$Any$filter, pred, dict));
    });
    ...
    var $author$project$Data$IdSet$IdSet = function(a) {
        return {
            $: 'IdSet',
            a: a
        };
    ...
    var $turboMaCk$any_dict$Dict$Any$fromList = F2(function(f, xs) {
        return $turboMaCk$any_dict$Dict$Any$AnyDict({
            dict: $elm$core$Dict$fromList(A2($elm$core$List$map, function(_v0) {
                var k = _v0.a;
                var v = _v0.b;
                return _Utils_Tuple2(f(k), _Utils_Tuple2(k, v));
            }, xs)),
            toKey: f
        });
    });
    var $turboMaCk$any_set$Set$Any$fromList = function(toComparable) {
        return A2($elm$core$Basics$composeL, A2($elm$core$Basics$composeL, $turboMaCk$any_set$Set$Any$AnySet, $turboMaCk$any_dict$Dict$Any$fromList(toComparable)), $elm$core$List$map(function(a) {
            return _Utils_Tuple2(a, _Utils_Tuple0);
        }));
    };
    var $author$project$Data$IdSet$fromList = function(list) {
        return $author$project$Data$IdSet$IdSet(A2($turboMaCk$any_set$Set$Any$fromList, $author$project$Data$Id$unwrap, list));
    };
    ...
    var $author$project$Data$Money$fromString = function(string) {
        var fixedString = A3($elm$core$String$replace, ',', '.', string);
        var fixWholeString = function(str) {
            return $elm$core$String$isEmpty(str) ? '0' : str;
        };
        var _v0 = A2($elm$core$String$split, '.', fixedString);
        _v0$2: while(true){
            if (_v0.b) {
                if (!_v0.b.b) {
                    var wholeStr = _v0.a;
                    return A2($elm$core$Maybe$map, function(whole) {
                        return A2($author$project$Data$Money$fromParts, whole, 0);
                    }, $elm$core$String$toInt(fixWholeString(wholeStr)));
                } else {
                    if (!_v0.b.b.b) {
                        var wholeStr = _v0.a;
                        var _v1 = _v0.b;
                        var centsStr = _v1.a;
                        var fixedWholeStr = fixWholeString(wholeStr);
                        var fixedCentsStr = A2($elm$core$String$left, 2, A3($elm$core$String$padRight, 2, _Utils_chr('0'), centsStr));
                        return A3($elm$core$Maybe$map2, $author$project$Data$Money$fromParts, $elm$core$String$toInt(fixedWholeStr), $elm$core$String$toInt(fixedCentsStr));
                    } else break _v0$2;
                }
            } else break _v0$2;
        }
    ...
    var $TSFoster$elm_uuid$UUID$UUID = F4(function(a, b, c, d) {
        return {
            $: 'UUID',
            a: a,
            b: b,
    ...
    var $elm$random$Random$map4 = F5(function(func, _v0, _v1, _v2, _v3) {
        var genA = _v0.a;
        var genB = _v1.a;
        var genC = _v2.a;
        var genD = _v3.a;
    ...
    var $TSFoster$elm_uuid$UUID$randomU32 = A2($elm$random$Random$map, $TSFoster$elm_uuid$UUID$forceUnsigned, A2($elm$random$Random$int, $elm$random$Random$minInt, $elm$random$Random$maxInt));
    ...
    var $TSFoster$elm_uuid$UUID$toVariant1 = function(_v0) {
        ...
        var c = _v0.c;
        var d = _v0.d;
        return A4($TSFoster$elm_uuid$UUID$UUID, a, b, $TSFoster$elm_uuid$UUID$forceUnsigned(2147483648 | 1073741823 & c), d);
    };
    var $elm$core$Bitwise$shiftLeftBy = _Bitwise_shiftLeftBy;
    var $TSFoster$elm_uuid$UUID$toVersion = F2(function(v, _v0) {
        var a = _v0.a;
        var b = _v0.b;
        var c = _v0.c;
        var d = _v0.d;
        return A4($TSFoster$elm_uuid$UUID$UUID, a, $TSFoster$elm_uuid$UUID$forceUnsigned(v << 12 | 4294905855 & b), c, d);
    });
    var $TSFoster$elm_uuid$UUID$generator = A2($elm$random$Random$map, A2($elm$core$Basics$composeR, $TSFoster$elm_uuid$UUID$toVersion(4), $TSFoster$elm_uuid$UUID$toVariant1), A5($elm$random$Random$map4, $TSFoster$elm_uuid$UUID$UUID, $TSFoster$elm_uuid$UUID$randomU32, $TSFoster$elm_uuid$UUID$randomU32, $TSFoster$elm_uuid$UUID$randomU32, $TSFoster$elm_uuid$UUID$randomU32));
    ...
    var $TSFoster$elm_uuid$UUID$toHex = F2(function(acc, _int) {
        toHex: while(true){
            if (!_int) return $elm$core$String$fromList(acc);
            else {
                var _char = function() {
                    var _v0 = 15 & _int;
                    switch(_v0){
                ...
                var $temp$acc = A2($elm$core$List$cons, _char, acc), $temp$int = _int >>> 4;
                acc = $temp$acc;
                _int = $temp$int;
                continue toHex;
            }
    ...
    var $TSFoster$elm_uuid$UUID$toStringWith = F2(function(sep, _v0) {
        var a = _v0.a;
        var b = _v0.b;
        var c = _v0.c;
        var d = _v0.d;
        return _Utils_ap(A3($elm$core$String$padLeft, 8, _Utils_chr('0'), A2($TSFoster$elm_uuid$UUID$toHex, _List_Nil, a)), _Utils_ap(sep, _Utils_ap(A3($elm$core$String$padLeft, 4, _Utils_chr('0'), A2($TSFoster$elm_uuid$UUID$toHex, _List_Nil, b >>> 16)), _Utils_ap(sep, _Utils_ap(A3($elm$core$String$padLeft, 4, _Utils_chr('0'), A2($TSFoster$elm_uuid$UUID$toHex, _List_Nil, 65535 & b)), _Utils_ap(sep, _Utils_ap(A3($elm$core$String$padLeft, 4, _Utils_chr('0'), A2($TSFoster$elm_uuid$UUID$toHex, _List_Nil, c >>> 16)), _Utils_ap(sep, _Utils_ap(A3($elm$core$String$padLeft, 4, _Utils_chr('0'), A2($TSFoster$elm_uuid$UUID$toHex, _List_Nil, 65535 & c)), A3($elm$core$String$padLeft, 8, _Utils_chr('0'), A2($TSFoster$elm_uuid$UUID$toHex, _List_Nil, d)))))))))));
    });
    var $TSFoster$elm_uuid$UUID$toString = $TSFoster$elm_uuid$UUID$toStringWith('-');
    var $author$project$Data$Id$generator = A2($elm$random$Random$map, A2($elm$core$Basics$composeR, $TSFoster$elm_uuid$UUID$toString, $author$project$Data$Id$Id), $TSFoster$elm_uuid$UUID$generator);
    ...
    var $turboMaCk$any_dict$Dict$Any$get = F2(function(k, _v0) {
        var dict = _v0.a.dict;
        var toKey = _v0.a.toKey;
        return A2($elm$core$Maybe$map, $elm$core$Tuple$second, A2($elm$core$Dict$get, toKey(k), dict));
    });
    var $author$project$Data$IdDict$get = F2(function(id, _v0) {
        var dict = _v0.a;
        return A2($turboMaCk$any_dict$Dict$Any$get, id, dict);
    });
    var $author$project$Data$IdDict$insert = F3(function(id, value, _v0) {
        var dict = _v0.a;
        return $author$project$Data$IdDict$IdDict(A3($turboMaCk$any_dict$Dict$Any$insert, id, value, dict));
    });
    var $turboMaCk$any_dict$Dict$Any$keys = A2($elm$core$Basics$composeL, $elm$core$List$map($elm$core$Tuple$first), $turboMaCk$any_dict$Dict$Any$toList);
    var $author$project$Data$IdDict$keys = function(_v0) {
        var dict = _v0.a;
    ...
    var $turboMaCk$any_dict$Dict$Any$member = F2(function(k, _v0) {
        var dict = _v0.a.dict;
        var toKey = _v0.a.toKey;
        return A2($elm$core$Dict$member, toKey(k), dict);
    });
    var $turboMaCk$any_set$Set$Any$member = F2(function(a, _v0) {
        var dict = _v0.a;
        return A2($turboMaCk$any_dict$Dict$Any$member, a, dict);
    });
    var $author$project$Data$IdSet$member = F2(function(id, _v0) {
        var set = _v0.a;
    ...
    var $turboMaCk$any_dict$Dict$Any$remove = F2(function(k, _v0) {
        var inner = _v0.a;
        return $turboMaCk$any_dict$Dict$Any$AnyDict(_Utils_update(inner, {
            dict: A2($elm$core$Dict$remove, inner.toKey(k), inner.dict)
        }));
    });
    var $author$project$Data$IdDict$remove = F2(function(id, _v0) {
        var dict = _v0.a;
        return $author$project$Data$IdDict$IdDict(A2($turboMaCk$any_dict$Dict$Any$remove, id, dict));
    });
    ...
    var $turboMaCk$any_dict$Dict$Any$update = F3(function(k, f, _v0) {
        var inner = _v0.a;
        var updateDict = A2($elm$core$Basics$composeL, A2($elm$core$Basics$composeL, $elm$core$Maybe$map(function(b) {
            return _Utils_Tuple2(k, b);
        }), f), $elm$core$Maybe$map($elm$core$Tuple$second));
        return $turboMaCk$any_dict$Dict$Any$AnyDict(_Utils_update(inner, {
            dict: A3($elm$core$Dict$update, inner.toKey(k), updateDict, inner.dict)
        }));
    });
    var $author$project$Data$IdDict$update = F3(function(id, fn, _v0) {
        var dict = _v0.a;
        return $author$project$Data$IdDict$IdDict(A3($turboMaCk$any_dict$Dict$Any$update, id, fn, dict));
    });
    var $author$project$Data$Money$zero = $author$project$Data$Money$Money(0);
    var $author$project$Main$update = F2(function(msg, model) {
        switch(msg.$){
            case 'ResetModel':
                return _Utils_Tuple2(A2($author$project$Main$initModel, model.idSeed, $author$project$Main$initSavedModel), $elm$core$Platform$Cmd$none);
            case 'FocusAttempted':
                return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
            case 'SetNewCategoryInput':
                var input_1 = msg.a;
                return _Utils_Tuple2(_Utils_update(model, {
                    newCategoryInput: input_1
                }), $elm$core$Platform$Cmd$none);
            case 'SetNewBucketInput':
                var categoryId = msg.a;
                var input_1 = msg.b;
                return _Utils_Tuple2(_Utils_update(model, {
                    newBucketInputs: A3($author$project$Data$IdDict$insert, categoryId, input_1, model.newBucketInputs)
                }), $elm$core$Platform$Cmd$none);
            case 'AddCategory':
                var categoryName = msg.a;
                if ($elm$core$String$isEmpty(categoryName)) return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
                else {
                    var _v1 = A2($elm$random$Random$step, $author$project$Data$Id$generator, model.idSeed);
                    var newCategoryId = _v1.a;
                    var newIdSeed = _v1.b;
                    return _Utils_Tuple2(_Utils_update(model, {
                        categories: A3($author$project$Data$IdDict$insert, newCategoryId, {
                            id: newCategoryId,
                            name: categoryName
                        }, model.categories),
                        categoriesOrder: _Utils_ap(model.categoriesOrder, _List_fromArray([
                            newCategoryId
                        ])),
                        idSeed: newIdSeed,
                        newCategoryInput: ''
                    }), $author$project$Main$focus($author$project$Main$AddBucketInput(newCategoryId)));
                }
            case 'AddBucket':
                var categoryId = msg.a;
                var bucketName = msg.b;
                if ($elm$core$String$isEmpty(bucketName)) return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
                else {
                    var _v2 = A2($elm$random$Random$step, $author$project$Data$Id$generator, model.idSeed);
                    var newBucketId = _v2.a;
                    var newIdSeed = _v2.b;
                    return _Utils_Tuple2(_Utils_update(model, {
                        ...
                        bucketsOrder: A3($author$project$Data$IdDict$update, categoryId, A2($elm$core$Basics$composeR, $elm$core$Maybe$map(function(order) {
                            return $elm$core$Maybe$Just(_Utils_ap(order, _List_fromArray([
                                newBucketId
                            ])));
                        }), $elm$core$Maybe$withDefault($elm$core$Maybe$Just(_List_fromArray([
                            newBucketId
                        ])))), model.bucketsOrder),
                        idSeed: newIdSeed,
                        newBucketInputs: A3($author$project$Data$IdDict$insert, categoryId, '', model.newBucketInputs)
                    }), $elm$core$Platform$Cmd$none);
                }
            case 'RemoveCategory':
                var categoryId = msg.a;
                var affectedBuckets = $author$project$Data$IdSet$fromList($author$project$Data$IdDict$keys(A2($author$project$Data$IdDict$filter, F2(function(_v4, bucket) {
                    return _Utils_eq(bucket.categoryId, categoryId);
                }), model.buckets)));
                return _Utils_Tuple2(_Utils_update(model, {
                    buckets: A2($author$project$Data$IdDict$filter, F2(function(bucketId, _v3) {
                        return !A2($author$project$Data$IdSet$member, bucketId, affectedBuckets);
                    }), model.buckets),
                    bucketsOrder: A2($author$project$Data$IdDict$remove, categoryId, model.bucketsOrder),
                    categories: A2($author$project$Data$IdDict$remove, categoryId, model.categories),
                    categoriesOrder: A2($elm$core$List$filter, $elm$core$Basics$neq(categoryId), model.categoriesOrder)
                }), $elm$core$Platform$Cmd$none);
            case 'RemoveBucket':
                var bucketId1 = msg.a;
                var _v5 = A2($author$project$Data$IdDict$get, bucketId1, model.buckets);
                if (_v5.$ === 'Nothing') return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
                else {
                    var bucket1 = _v5.a;
                    return _Utils_Tuple2(_Utils_update(model, {
                        buckets: A2($author$project$Data$IdDict$filter, F2(function(id, _v6) {
                            return !_Utils_eq(id, bucketId1);
                        }), model.buckets),
                        bucketsOrder: A3($author$project$Data$IdDict$update, bucket1.categoryId, $elm$core$Maybe$map($elm$core$List$filter($elm$core$Basics$neq(bucketId1))), model.bucketsOrder)
                    }), $elm$core$Platform$Cmd$none);
                }
            case 'StartMoneyOp':
                var bucketId1 = msg.a;
                var moneyOp1 = msg.b;
                return _Utils_Tuple2(_Utils_update(model, {
                    bucketMoneyOps: A3($author$project$Data$IdDict$insert, bucketId1, moneyOp1, model.bucketMoneyOps)
                }), $author$project$Main$focus($author$project$Main$MoneyOpInput(bucketId1)));
            case 'CancelMoneyOp':
                var bucketId1 = msg.a;
                return _Utils_Tuple2(_Utils_update(model, {
                    bucketMoneyOps: A2($author$project$Data$IdDict$remove, bucketId1, model.bucketMoneyOps)
                }), $elm$core$Platform$Cmd$none);
            case 'SelectMoneyOpTargetBucket':
                var bucketId1 = msg.a;
                var targetBucketId1 = msg.b;
                return _Utils_Tuple2(_Utils_update(model, {
                    bucketMoneyOps: A3($author$project$Data$IdDict$update, bucketId1, $elm$core$Maybe$map(function(op) {
                        if (op.$ === 'MoveToM') {
                            var input_ = op.b;
                            return A2($author$project$Main$MoveToM, $elm$core$Maybe$Just(targetBucketId1), input_);
                        } else return op;
                    }), model.bucketMoneyOps)
                }), $elm$core$Platform$Cmd$none);
            case 'SetMoneyOpInput':
                var bucketId1 = msg.a;
                var input_1 = msg.b;
                return _Utils_Tuple2(_Utils_update(model, {
                    bucketMoneyOps: A3($author$project$Data$IdDict$update, bucketId1, $elm$core$Maybe$map(function(op) {
                        switch(op.$){
                            case 'AddM':
                                return $author$project$Main$AddM(input_1);
                            case 'SubtractM':
            ...
            default:
                var bucketId1 = msg.a;
                return A2($elm$core$Maybe$withDefault, _Utils_Tuple2(model, $elm$core$Platform$Cmd$none), A2($elm$core$Maybe$andThen, function(_v9) {
                    var moneyOp = _v9.a;
                    var bucket = _v9.b;
                    var singleBucketOp = function(moneyFn) {
                        var newBucket = _Utils_update(bucket, {
                            value: moneyFn(bucket.value)
                        });
                        return _Utils_Tuple2(_Utils_update(model, {
                            bucketMoneyOps: A2($author$project$Data$IdDict$remove, bucketId1, model.bucketMoneyOps),
                            buckets: A3($author$project$Data$IdDict$insert, bucketId1, newBucket, model.buckets)
                        }), $elm$core$Platform$Cmd$none);
                    };
                    switch(moneyOp.$){
                        case 'SubtractM':
                            var valueString = moneyOp.a;
                            return A2($elm$core$Maybe$map, A2($elm$core$Basics$composeL, singleBucketOp, $author$project$Data$Money$subtract), $author$project$Data$Money$fromString(valueString));
                        case 'AddM':
                            var valueString = moneyOp.a;
                            return A2($elm$core$Maybe$map, A2($elm$core$Basics$composeL, singleBucketOp, $author$project$Data$Money$add), $author$project$Data$Money$fromString(valueString));
                        case 'SetM':
                            var valueString = moneyOp.a;
                            return A2($elm$core$Maybe$map, A2($elm$core$Basics$composeL, singleBucketOp, F2(function(value, _v11) {
                                return value;
                            })), $author$project$Data$Money$fromString(valueString));
                        default:
                            var targetBucketId = moneyOp.a;
                            var valueString = moneyOp.b;
                            return A3($elm$core$Maybe$map2, F2(function(value, targetBucket) {
                                var newTargetBucket = _Utils_update(targetBucket, {
                                    value: A2($author$project$Data$Money$add, value, targetBucket.value)
                                });
                                var newSourceBucket = _Utils_update(bucket, {
                                    value: A2($author$project$Data$Money$subtract, value, bucket.value)
                                });
                                return _Utils_Tuple2(_Utils_update(model, {
                                    bucketMoneyOps: A2($author$project$Data$IdDict$remove, bucketId1, model.bucketMoneyOps),
                                    buckets: A3($author$project$Data$IdDict$insert, targetBucket.id, newTargetBucket, A3($author$project$Data$IdDict$insert, bucketId1, newSourceBucket, model.buckets))
                                }), $elm$core$Platform$Cmd$none);
                            }), $author$project$Data$Money$fromString(valueString), A2($elm$core$Maybe$andThen, function(id) {
                                return A2($author$project$Data$IdDict$get, id, model.buckets);
                            }, targetBucketId));
                    }
                }, A3($elm$core$Maybe$map2, $elm$core$Tuple$pair, A2($author$project$Data$IdDict$get, bucketId1, model.bucketMoneyOps), A2($author$project$Data$IdDict$get, bucketId1, model.buckets))));
        }
    });
    ...
    var $author$project$Main$AddCategory = function(a) {
        return {
            $: 'AddCategory',
            a: a
        };
    ...
    var $author$project$Main$ResetModel = {
        $: 'ResetModel'
    };
    var $author$project$Main$SetNewCategoryInput = function(a) {
        return {
            $: 'SetNewCategoryInput',
            a: a
        };
    };
    var $author$project$Main$Sky = {
        $: 'Sky'
    };
    ...
    var $author$project$Main$SetNewBucketInput = F2(function(a, b) {
        return {
            $: 'SetNewBucketInput',
            a: a,
            b: b
    ...
    var $author$project$Main$CancelMoneyOp = function(a) {
        return {
            $: 'CancelMoneyOp',
            a: a
        };
    ...
    var $author$project$Main$RemoveBucket = function(a) {
        return {
            $: 'RemoveBucket',
            a: a
        };
    ...
    var $author$project$Main$SetMoneyOpInput = F2(function(a, b) {
        return {
            $: 'SetMoneyOpInput',
            a: a,
            b: b
    ...
    var $author$project$Main$StartMoneyOp = F2(function(a, b) {
        return {
            $: 'StartMoneyOp',
            a: a,
            b: b
    ...
    var $author$project$Icons$fontAwesomeIcon = F2(function(viewBox, path) {
    ...
    var $elm_community$html_extra$Html$Events$Extra$onEnter = function(onEnterAction) {
        return A2($elm$html$Html$Events$on, 'keyup', A2($elm$json$Json$Decode$andThen, function(keyCode) {
            return keyCode === 13 ? $elm$json$Json$Decode$succeed(onEnterAction) : $elm$json$Json$Decode$fail($elm$core$String$fromInt(keyCode));
    ...
    var $author$project$Main$valuePill = function(money) {
        return A2($elm$html$Html$div, _List_fromArray([
            $elm$html$Html$Attributes$class('rounded bg-lime-200 px-2 border border-lime-400 text-lime-600 hover:bg-lime-300 hover:border-lime-500')
        ]), _List_fromArray([
    ...
    var $author$project$Main$bucketView = F2(function(model, bucket) {
        ...
        var singleBucketView = F2(function(valueString, placeholder) {
            return A2($elm$html$Html$div, _List_fromArray([
                ...
                A2($author$project$Main$input, _List_fromArray([
                    $elm$html$Html$Events$onInput($author$project$Main$SetMoneyOpInput(bucket.id)),
                    $elm_community$html_extra$Html$Events$Extra$onEnter($author$project$Main$FinishMoneyOp(bucket.id)),
                    $elm$html$Html$Attributes$placeholder(placeholder),
                    $author$project$Main$domId($author$project$Main$MoneyOpInput(bucket.id))
                ]), valueString),
        ...
        return A2($elm$html$Html$div, _List_fromArray([
            ...
            A2($elm$html$Html$div, _List_fromArray([
                ...
                function() {
                    if (moneyOp.$ === 'Nothing') return A2($elm$html$Html$div, _List_fromArray([
                        $elm$html$Html$Attributes$class('flex gap-1 align-stretch')
                    ]), _List_fromArray([
                        A3($author$project$Main$button, $author$project$Main$Sky, _List_fromArray([
                            $elm$html$Html$Events$onClick(A2($author$project$Main$StartMoneyOp, bucket.id, $author$project$Main$SubtractM('')))
                        ]), _List_fromArray([
                            $author$project$Icons$minus
                        ])),
                        A3($author$project$Main$button, $author$project$Main$Sky, _List_fromArray([
                            $elm$html$Html$Events$onClick(A2($author$project$Main$StartMoneyOp, bucket.id, $author$project$Main$AddM('')))
                        ]), _List_fromArray([
                            $author$project$Icons$plus
                        ])),
                        A3($author$project$Main$button, $author$project$Main$Sky, _List_fromArray([
                            $elm$html$Html$Events$onClick(A2($author$project$Main$StartMoneyOp, bucket.id, $author$project$Main$SetM('')))
                        ]), _List_fromArray([
                            $author$project$Icons$equals
                        ])),
                        A3($author$project$Main$button, $author$project$Main$Sky, _List_fromArray([
                            $elm$html$Html$Events$onClick(A2($author$project$Main$StartMoneyOp, bucket.id, A2($author$project$Main$MoveToM, $elm$core$Maybe$Nothing, '')))
                        ]), _List_fromArray([
                            $author$project$Icons$arrowRight
                        ]))
                    ]));
                    else switch(moneyOp.a.$){
                        case 'SubtractM':
                            var valueString = moneyOp.a.a;
                            return A2(singleBucketView, valueString, 'Amount to subtract');
                        case 'AddM':
                            var valueString = moneyOp.a.a;
                            return A2(singleBucketView, valueString, 'Amount to add');
                        case 'SetM':
                            var valueString = moneyOp.a.a;
                            return A2(singleBucketView, valueString, 'Amount to set');
                        default:
                            var _v1 = moneyOp.a;
                            var targetBucketId = _v1.a;
                            var valueString = _v1.b;
                            var targetBucketMsgDecoder = A2($elm$json$Json$Decode$map, $author$project$Main$SelectMoneyOpTargetBucket(bucket.id), A2($elm$json$Json$Decode$at, _List_fromArray([
                                'target',
                                'value'
                ...
                A3($author$project$Main$button, $author$project$Main$Orange, _List_fromArray([
                    $elm$html$Html$Events$onClick($author$project$Main$RemoveBucket(bucket.id))
                ]), _List_fromArray([
                    $author$project$Icons$xmark
                ]))
            ]))
        ...
        return A2($elm$html$Html$div, _List_fromArray([
            ...
            A2($elm$html$Html$div, _List_fromArray([
                ...
                A2($elm$html$Html$div, _List_fromArray([
                    ...
                    A3($author$project$Main$button, $author$project$Main$Orange, _List_fromArray([
                        $elm$html$Html$Events$onClick($author$project$Main$RemoveCategory(category.id))
                    ]), _List_fromArray([
                        $author$project$Icons$xmark
                    ]))
                ]))
            ...
            ]), A2($elm$core$List$map, $author$project$Main$bucketView(model), buckets)),
            A2($elm$html$Html$div, _List_fromArray([
                $elm$html$Html$Attributes$class('flex gap-2')
            ]), _List_fromArray([
                A2($author$project$Main$input, _List_fromArray([
                    $elm$html$Html$Events$onInput($author$project$Main$SetNewBucketInput(category.id)),
                    $elm_community$html_extra$Html$Events$Extra$onEnter(addBucket),
                    $elm$html$Html$Attributes$placeholder('New bucket name'),
                    $author$project$Main$domId($author$project$Main$AddBucketInput(category.id))
                ]), newBucketInput),
                A3($author$project$Main$button, $author$project$Main$Sky, _List_fromArray([
                    $elm$html$Html$Events$onClick(addBucket)
                ]), _List_fromArray([
                    $elm$html$Html$text('Add bucket')
                ]))
            ]))
        ]));
    });
    ...
    var $author$project$Main$debugView = F2(function(label, value) {
        return A2($elm$html$Html$div, _List_fromArray([
            $elm$html$Html$Attributes$class('flex flex-col gap-2 p-2 border border-fuchsia-100 bg-fuchsia-50')
        ]), _List_fromArray([
            A2($elm$html$Html$div, _List_fromArray([
                $elm$html$Html$Attributes$class('text-fuchsia-700 text-[14px]')
            ]), _List_fromArray([
                $elm$html$Html$text('Debugging '),
                A2($elm$html$Html$code, _List_fromArray([
                    $elm$html$Html$Attributes$class('border border-fuchsia-200 bg-fuchsia-100 px-1 text-[12px]')
                ]), _List_fromArray([
            ...
            A2($elm$html$Html$pre, _List_fromArray([
                $elm$html$Html$Attributes$class('break-all whitespace-pre-wrap overflow-x-hidden p-2 bg-fuchsia-100 text-[12px] text-fuchsia-600')
            ]), _List_fromArray([
                $elm$html$Html$text($elm$core$Debug$toString(value))
            ]))
        ]));
    });
    ...
    var $author$project$Main$view = function(model) {
        ...
        return A2($elm$html$Html$div, _List_fromArray([
            ...
            A2($elm$html$Html$div, _List_fromArray([
                ...
                A2($author$project$Main$input, _List_fromArray([
                    $elm$html$Html$Events$onInput($author$project$Main$SetNewCategoryInput),
                    $elm_community$html_extra$Html$Events$Extra$onEnter(addCategory),
                    $elm$html$Html$Attributes$placeholder('New category name'),
                    $author$project$Main$domId($author$project$Main$AddCategoryInput)
            ...
            A2($author$project$Main$debugView, 'categories', model.categories),
            A2($author$project$Main$debugView, 'buckets', model.buckets),
            A2($author$project$Main$debugView, 'categoriesOrder', model.categoriesOrder),
            A2($author$project$Main$debugView, 'bucketsOrder', model.bucketsOrder),
            A2($elm$html$Html$div, _List_Nil, _List_fromArray([
                A3($author$project$Main$button, $author$project$Main$Orange, _List_fromArray([
                    $elm$html$Html$Events$onClick($author$project$Main$ResetModel)
                ]), _List_fromArray([
                    $author$project$Icons$trashCan,
                    $elm$html$Html$text('Nuke the model')
                ]))
            ]))
        ]));
    };
    var $author$project$Main$main = $elm$browser$Browser$element({
        ...
        update: $author$project$Main$update_,
        view: $author$project$Main$view
    });
    _Platform_export({
        'Main': {
            'init': $author$project$Main$main(A2($elm$json$Json$Decode$andThen, function(savedModel) {
                return A2($elm$json$Json$Decode$andThen, function(idSeed) {
                    return $elm$json$Json$Decode$succeed({
                        idSeed: idSeed,
                        savedModel: savedModel
                    });
                }, A2($elm$json$Json$Decode$field, 'idSeed', $elm$json$Json$Decode$int));
            }, A2($elm$json$Json$Decode$field, 'savedModel', $elm$json$Json$Decode$oneOf(_List_fromArray([
                $elm$json$Json$Decode$null($elm$core$Maybe$Nothing),
                A2($elm$json$Json$Decode$map, $elm$core$Maybe$Just, $elm$json$Json$Decode$string)
            ])))))(0)
        }
    });
})($ed95c0d5fbea41b7$exports);


const $d3d62a653380dacf$var$localStorageKey = 'elm-app';
const $d3d62a653380dacf$var$savedModel = localStorage.getItem($d3d62a653380dacf$var$localStorageKey);
const $d3d62a653380dacf$var$idSeed = +new Date();
const $d3d62a653380dacf$var$app = $ed95c0d5fbea41b7$exports.Elm.Main.init({
    node: document.getElementById('app'),
    flags: {
        savedModel: $d3d62a653380dacf$var$savedModel,
        idSeed: $d3d62a653380dacf$var$idSeed
    }
});
$d3d62a653380dacf$var$app.ports.saveToLocalStorage.subscribe((string)=>{
    localStorage.setItem($d3d62a653380dacf$var$localStorageKey, string);
});

...
*/ var _Scheduler_working = false;
    ...
    var $author$project$Main$encodeSavedModel = function(model) {
        return A2($elm$json$Json$Encode$encode, 0, $elm$json$Json$Encode$object(_List_fromArray([
            ...
            _Utils_Tuple2('toBeBudgeted', $author$project$Data$Money$encode(model.toBeBudgeted)),
    ...
    var $author$project$Main$toBeBudgetedValue = 'to-be-budgeted';
    var $author$project$Main$bucketTypeToString = function(bucketType) {
        if (bucketType.$ === 'ToBeBudgeted') return $author$project$Main$toBeBudgetedValue;
        else {
            var bucketId = bucketType.a;
            return $author$project$Data$Id$unwrap(bucketId);
        }
    };
    var $author$project$Main$domIdToString = function(domId_) {
        switch(domId_.$){
            ...
            default:
                var bucketType = domId_.a;
                return 'money-op-' + $author$project$Main$bucketTypeToString(bucketType);
        }
    };
    ...
    var $author$project$Main$initModel = F2(function(idSeed, savedModel) {
        return {
            ...
            toBeBudgetedMoneyOp: $elm$core$Maybe$Nothing
        };
    });
    ...
    var $author$project$Main$initSavedModel = {
        ...
        toBeBudgeted: $author$project$Data$Money$zero
    };
    ...
    var $author$project$Main$SavedModel = F5(function(categories, buckets, toBeBudgeted, categoriesOrder, bucketsOrder) {
        return {
            buckets: buckets,
    ...
    var $author$project$Main$closeMoneyOp = F2(function(bucketType, model) {
        if (bucketType.$ === 'ToBeBudgeted') return _Utils_update(model, {
            ...
            return _Utils_update(model, {
                bucketMoneyOps: A2($author$project$Data$IdDict$remove, bucketId, model.bucketMoneyOps)
            });
        }
    });
    ...
    var $author$project$Main$getMoneyOp = F2(function(bucketType, model) {
        if (bucketType.$ === 'ToBeBudgeted') return model.toBeBudgetedMoneyOp;
        else {
            var bucketId = bucketType.a;
            return A2($author$project$Data$IdDict$get, bucketId, model.bucketMoneyOps);
        }
    });
    ...
    var $author$project$Main$updateMoney = F3(function(bucketType, moneyFn, model) {
        if (bucketType.$ === 'ToBeBudgeted') return _Utils_update(model, {
            ...
            var bucketId = bucketType.a;
            return _Utils_update(model, {
                buckets: A3($author$project$Data$IdDict$update, bucketId, $elm$core$Maybe$map(function(bucket) {
    ...
    var $author$project$Main$update = F2(function(msg, model) {
        switch(msg.$){
            ...
            case 'RemoveCategory':
                var categoryId = msg.a;
                var affectedBucketsDict = A2($author$project$Data$IdDict$filter, F2(function(_v4, bucket) {
                    return _Utils_eq(bucket.categoryId, categoryId);
                }), model.buckets);
                var lostValue = A3($elm$core$List$foldl, $author$project$Data$Money$add, $author$project$Data$Money$zero, A2($elm$core$List$map, function($) {
                    return $.value;
                }, $author$project$Data$IdDict$values(affectedBucketsDict)));
                var affectedBucketIds = $author$project$Data$IdSet$fromList($author$project$Data$IdDict$keys(affectedBucketsDict));
                return _Utils_Tuple2(_Utils_update(model, {
                    buckets: A2($author$project$Data$IdDict$filter, F2(function(bucketId, _v3) {
                        return !A2($author$project$Data$IdSet$member, bucketId, affectedBucketIds);
                    }), model.buckets),
                    ...
                    toBeBudgeted: A2($author$project$Data$Money$add, lostValue, model.toBeBudgeted)
                }), $elm$core$Platform$Cmd$none);
            case 'RemoveBucket':
                var bucketId1 = msg.a;
                ...
                if (_v5.$ === 'Nothing') return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
                    ...
                    return _Utils_Tuple2(_Utils_update(model, {
                        ...
                        toBeBudgeted: A2($author$project$Data$Money$add, bucket1.value, model.toBeBudgeted)
                    }), $elm$core$Platform$Cmd$none);
                }
            case 'StartMoneyOp':
                ...
                return _Utils_Tuple2(function() {
                    if (bucketType.$ === 'ToBeBudgeted') return _Utils_update(model, {
                        toBeBudgetedMoneyOp: $elm$core$Maybe$Just(moneyOp1)
                    });
                    else {
                        var bucketId = bucketType.a;
                        return _Utils_update(model, {
                            bucketMoneyOps: A3($author$project$Data$IdDict$insert, bucketId, moneyOp1, model.bucketMoneyOps)
                        });
                    }
                }(), $author$project$Main$focus($author$project$Main$MoneyOpInput(bucketType)));
            case 'CancelMoneyOp':
                var bucketType = msg.a;
            ...
            case 'SelectMoneyOpTargetBucket':
                ...
                return _Utils_Tuple2(function() {
                    if (bucketType.$ === 'ToBeBudgeted') return _Utils_update(model, {
                        toBeBudgetedMoneyOp: A2($elm$core$Maybe$map, fn, model.toBeBudgetedMoneyOp)
                    });
                    else {
                        var bucketId = bucketType.a;
                        return _Utils_update(model, {
                            bucketMoneyOps: A3($author$project$Data$IdDict$update, bucketId, $elm$core$Maybe$map(fn), model.bucketMoneyOps)
                        });
                    }
                }(), $elm$core$Platform$Cmd$none);
    ...
    var $author$project$Main$ToBeBudgeted = {
        $: 'ToBeBudgeted'
    };
    ...
    var $author$project$Data$Money$isNegative = function(money) {
        return (function(n) {
            return n < 0;
        })($author$project$Data$Money$toParts(money).a);
    };
    var $author$project$Main$isValidNumber = function(valueString) {
        var _v0 = $author$project$Data$Money$fromString(valueString);
        if (_v0.$ === 'Just') {
            var money = _v0.a;
            return !$author$project$Data$Money$isNegative(money);
        } else return false;
    };
    ...
    var $author$project$Main$moneyOpView = F2(function(config, moneyOp) {
        ...
        if (moneyOp.$ === 'Nothing') return A2($elm$html$Html$div, _List_fromArray([
            ...
            A3($author$project$Main$button, $author$project$Main$Sky, _List_fromArray([
                $elm$html$Html$Events$onClick(config.startMoneyOp($author$project$Main$SubtractM('')))
            ]), _List_fromArray([
                $author$project$Icons$minus
            ])),
            A3($author$project$Main$button, $author$project$Main$Sky, _List_fromArray([
                $elm$html$Html$Events$onClick(config.startMoneyOp($author$project$Main$AddM('')))
            ]), _List_fromArray([
                $author$project$Icons$plus
            ])),
            A3($author$project$Main$button, $author$project$Main$Sky, _List_fromArray([
                $elm$html$Html$Events$onClick(config.startMoneyOp($author$project$Main$SetM('')))
            ]), _List_fromArray([
                $author$project$Icons$equals
            ])),
            A3($author$project$Main$button, $author$project$Main$Sky, _List_fromArray([
                $elm$html$Html$Events$onClick(config.startMoneyOp(A2($author$project$Main$MoveToM, $elm$core$Maybe$Nothing, '')))
            ]), _List_fromArray([
    ...
    var $author$project$Main$categoryView = F3(function(model, categoriesAndBuckets, _v0) {
        var category = _v0.a;
        var buckets = _v0.b;
        ...
        return A2($elm$html$Html$div, _List_fromArray([
            ...
            ]), A2($elm$core$List$map, A2($author$project$Main$bucketView, model, categoriesAndBuckets), buckets)),
            A2($elm$html$Html$div, _List_fromArray([
                $elm$html$Html$Attributes$class('flex gap-2')
            ]), _List_fromArray([
                A2($author$project$Main$input, _List_fromArray([
    ...
    var $author$project$Main$view = function(model) {
        ...
        return A2($elm$html$Html$div, _List_fromArray([
            ...
            A2($elm$html$Html$div, _List_fromArray([
                ...
                A2($elm$html$Html$div, _List_fromArray([
                    $elm$html$Html$Attributes$class('flex flex-col gap-2 items-end')
                ]), _List_fromArray([
                    A2($elm$html$Html$div, _List_fromArray([
                        $elm$html$Html$Attributes$class('flex gap-2')
                    ]), _List_fromArray([
            ...
            ]), A2($elm$core$List$map, A2($author$project$Main$categoryView, model, categoriesAndBuckets), categoriesAndBuckets)),
            A2($elm$html$Html$div, _List_fromArray([
                $elm$html$Html$Attributes$class('flex gap-2')
            ]), _List_fromArray([
                A2($author$project$Main$input, _List_fromArray([
